...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in data.frame(school, number.students, grade.average, teacher) \%>\% : could not find function "{}\%>\%"{}}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in data.frame(client, depression.1, depression.2, depression.3, : could not find function "{}\%>\%"{}}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in data.frame(company = c("{}Daisy's"{}, "{}Burger Queen"{}), tax.2016 = c(569875, : could not find function "{}\%>\%"{}}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in data\_frame(value) \%>\% group\_by(value) \%>\% summarise(frequency = n(), : could not find function "{}\%>\%"{}}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in data\_frame(age) \%>\% group\_by(age) \%>\% summarise(frequency = n(), : could not find function "{}\%>\%"{}}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in data.frame(x) \%>\% group\_by(x) \%>\% summarise(frequency = n(), : could not find function "{}\%>\%"{}}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in rchisq(100, 4) \%>\% round: could not find function "{}\%>\%"{}}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in data\_frame(income) \%>\% ggplot(aes(income)): could not find function "{}\%>\%"{}}}\end{kframe}
