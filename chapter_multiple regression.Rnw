...
out2 %>% summary() %>% xtable(caption="Regression table for predicting age from heart", label="tab:multi_2b") %>%
        print(include.rownames=T, caption.placement = "top")
@
...
out3 %>% summary() %>% xtable(caption="Regression table for predicting age from heart and weight", label="tab:multi_2c") %>%
        print(include.rownames=T, caption.placement = "top")
@
