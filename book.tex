...
The OLS linear model parameters are in the $estimate$ column of the R output, but there are also a number of other columns. These will be discussed in Chapters \ref{chap:confidence} and \ref{chap:hypothesis}.  % simple regression
...
term & estimate & std.error & statistic & p.value \\ 
  \hline
(Intercept) & 4.66 & 0.20 & 22.94 & 0.00 \\ 
  grouptrt2 & 0.87 & 0.29 & 3.01 & 0.01 \\ 
   \hline
\end{tabular}
\end{table}
